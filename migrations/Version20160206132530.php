...
class Version20160206132530 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE option_contract (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(4) NOT NULL, strike DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE option_contract');
    }
}
